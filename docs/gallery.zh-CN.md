...
在中英双语艺术网页中，用 Three.js 创建随鼠标、滚动与键盘操作响应的绘画风格孔雀。

**作者**: [@lepadphone](https://x.com/lepadphone/status/2096147245775331419) · 2026-09-05<br>
**工具与技术**: Three.js

**创作方法**

把配色、运动规则、羽毛交互、音效与触屏操作写成一份完整需求。
...
↗ [查看作者完整提示词](https://x.com/lepadphone/status/2096147248551694472) · [观看演示](https://x.com/lepadphone/status/2096147245775331419)
...
Astra 重新设计已有的 iPad 遥操作应用，在改进界面的同时把作者报告的控制延迟降到约 4–5 毫秒。

**作者**: [@Alpha10six](https://x.com/Alpha10six/status/2096352482746147085) · 2026-09-06<br>
**工具与技术**: iPadOS, Robot control, Latency

**创作方法**

把可运行应用交给 Astra，直接指定视觉质量、交互设计和延迟三项重点，让它在现有系统上改进而不是从零重做。

**值得注意**

延迟数据及与早期 GPT-5.6 Sol 版本的比较来自作者自述，本项目未独立测量。
...
**作者**: [@jaimintf](https://x.com/jaimintf/status/2095863849635422679) · 2026-09-04<br>
**工具与技术**: Appllama MCP, App design skills, Liquid glass

**创作方法**

明确页面目标与可用设计工具，并为玻璃效果给出具体的交互参考。

**值得注意**

该成果使用了作者环境中已有的 Appllama MCP 与应用设计技能。
...
↗ [查看作者完整提示词](https://x.com/jaimintf/status/2095865097830936773) · [观看演示](https://x.com/jaimintf/status/2095863849635422679)
...
| 项目 | 已知信息与缺口 |
| --- | --- |
| 软件与环境 | 已收录提示词使用作者环境中已有的 Appllama MCP 与 App design skills，现有资料未提供版本和配置步骤。 |
| 输入素材 | 提示词以 Wabi 为液态玻璃位移效果参考；现有资料未说明具体参考文件、输入美术素材及复用条款。 |
| 服务与账号 | 原文提到 Appllama MCP，但本案例资料未说明账号、授权和计费要求。 |
| 源码与演示入口 | 目录提供完整提示词与成果原帖，未记录源码仓库或可安装应用。 |

#### 提示词拆解 · 项目分析

作者提示词原文见上方。以下拆解和验收建议是项目分析，不是作者原文，也不是独立实测结果。

**目标**：welcome screen 把范围收束到一个欢迎界面；星空主题提供美术方向，并非完整应用需求。

**约束**：工具名称约束工作流程，Wabi 参考约束交互方向；这条短提示词没有规定具体实现方式。

**交付**：原文未规定可编辑工程、目标平台和页面跳转。建议补充目标平台，并要求可编辑页面与可操作的主按钮。

**验收建议**：建议验收，尚未执行：检查背景上的文字可读性，点击主按钮，调整窗口，并在目标设备测试动态效果；静态图片不能证明位移交互有效。

**可借鉴之处**：视觉参考有助于表达风格，还应配套明确的行为与交付要求。不要默认另一套环境拥有作者使用的工具。

所依据的已收录来源：[@jaimintf · 2095863849635422679](https://x.com/jaimintf/status/2095863849635422679) · [@jaimintf · 2095865097830936773](https://x.com/jaimintf/status/2095865097830936773)
...
一句话让 Astra 把记住的加勒比背景、巴黎生活、黄色、咖啡、家庭、信仰与创造力组合成个人化插画。

**作者**: [@karatademada](https://x.com/karatademada/status/2096119414315778504) · 2026-09-05<br>
**工具与技术**: Image generation, Memory, Portrait

**创作方法**

直接把 ChatGPT 记忆当作创意简报，把构图和视觉隐喻留给 Astra 从过往对话中推断。

**值得注意**

结果取决于账号记忆中保存的内容，其他用户会得到截然不同的图像。
...
↗ [查看作者完整提示词](https://x.com/karatademada/status/2096119414315778504) · [观看演示](https://x.com/karatademada/status/2096119414315778504)
...
**作者**: [@Ror_Fly](https://x.com/Ror_Fly/status/2096629184512610370) · 2026-09-06<br>
**工具与技术**: Midjourney, Art direction, Prompt design

**创作方法**

让 Astra 可视化自己的心智，并由它选择视觉参考和参数，再把生成的美术指导提示词交给 Midjourney。

**值得注意**

Astra 负责编写并指导提示词，图像由 Midjourney 渲染，因此结果同时体现两个系统。
...
↗ [查看作者完整提示词](https://x.com/Ror_Fly/status/2096629184512610370) · [观看演示](https://x.com/Ror_Fly/status/2096629184512610370)
...
Astra 制作了精致的移动端欢迎体验，把层叠星体图像、可触摸的液态玻璃位移和动画转场组合起来。

**作者**: [@jaimintf](https://x.com/jaimintf/status/2095896717225087132) · 2026-09-04<br>
**工具与技术**: Appllama MCP, Liquid glass, Mobile UI

**创作方法**

将长时间目标、Appllama MCP 与应用设计 skills 结合，明确交互技术，再给出由 Astra 发挥的视觉主题。

**值得注意**

结果依赖 Appllama MCP 和外部应用设计 skills；作者报告 Astra 运行约 1 小时 25 分钟。
...
↗ [查看作者完整提示词](https://x.com/jaimintf/status/2095902644925768099) · [观看演示](https://x.com/jaimintf/status/2095896717225087132)
...
**验收建议**：建议验收，尚未执行：重新打开工程，检查对象组织、旋转视角及外部素材是否齐全；比例检查应依据实际提供的参考图。
...
**作者**: [@DeryaTR_](https://x.com/DeryaTR_/status/2095659170661904804) · 2026-09-04<br>
**工具与技术**: Remotion, Imagegen, HeyGen

**创作方法**

作者给出主题并指定 Remotion，随后由 Astra 组织视觉素材、旁白和剪辑。
...
↗ [查看作者完整提示词](https://x.com/DeryaTR_/status/2095659170661904804) · [观看演示](https://x.com/DeryaTR_/status/2095659170661904804)
...
根据房源照片重建 Blender 场景，并生成约一分钟、镜头连续流畅的宣传漫游视频。

**作者**: [@realYunfanYe](https://x.com/realYunfanYe/status/2095612137582526615) · 2026-09-04<br>
**工具与技术**: Blender, Rome, Cinematography

**创作方法**

提供房源链接，要求用无头 Blender 重建，再明确一镜到底的电影化运镜，并要求视觉检查和迭代打磨。

**值得注意**

作者说明一次生成的结果仍有几何细节错误，并使用了已有的 Rome 工作流抓取房源图片和添加音频。
...
↗ [查看作者完整提示词](https://x.com/realYunfanYe/status/2095664943421067611) · [观看演示](https://x.com/realYunfanYe/status/2095612137582526615)
...
**作者**: [@Mayz1169](https://x.com/Mayz1169/status/2095873015007592679) · 2026-09-04<br>
**工具与技术**: Prompt design, Animation, Cinematic pacing

**创作方法**

先让 Astra 编写生产级提示词，锁定时长、画幅、节奏、镜头连续性、动作节点、光照和视觉风格，再交给动画模型生成。

**值得注意**

Astra 负责生成提示词；原帖没有注明最终渲染视频所用的下游动画模型。
...
↗ [查看作者完整提示词](https://x.com/Mayz1169/status/2095873204351070296) · [观看演示](https://x.com/Mayz1169/status/2095873015007592679)
...
**作者**: [@Mayz1169](https://x.com/Mayz1169/status/2096470693089292710) · 2026-09-06<br>
**工具与技术**: Seedance 2.5, Renoise CLI, Character consistency

**创作方法**

把角色一致性与动作分开：先制作精细角色设定表，再用第二条提示词让同一角色贯穿连续高速镜头。

**值得注意**

Astra 生成两条制作提示词；动画由 Seedance 2.5 渲染，并通过 Renoise CLI 编排下游生成。
...
↗ [查看作者完整提示词](https://x.com/Mayz1169/status/2096471302949548242) · [观看演示](https://x.com/Mayz1169/status/2096470693089292710)
...
Astra 与 Higgsfield MCP 把动作参考和旧 Reel 转化为四条完成剪辑的社交视频，并展示了最终导出成片。

**作者**: [@adilinthewild](https://x.com/adilinthewild/status/2096566097365602565) · 2026-09-06<br>
**工具与技术**: Higgsfield MCP, Social video, Reference-driven editing

**创作方法**

附上目标动作参考和一条有代表性的旧 Reel，直接要求交付最终成片，而不是只给概念或剪辑计划。

**值得注意**

流程依赖 Higgsfield MCP 以及作者提供的源视频和动作参考；作者称没有进行人工剪辑。
...
**作者**: [@MatthewBerman](https://x.com/MatthewBerman/status/2095595901784052075) · 2026-09-04<br>
**工具与技术**: Browser control, Travel, Computer use

**创作方法**

只需明确目的地和体验类型，再让 Astra 自主操作浏览器并组织漫游内容。

**值得注意**

公开帖子展示了浏览器操作过程，但没有逐项列出中间浏览步骤和来源筛选标准。
...
**验收建议**：建议验收，尚未执行：检查左右控制、障碍碰撞、明确的结束状态和重新开始；分别检查静音及有声游玩，并将水体行为与美术偏好分开记录。
...
**验收建议**：建议验收，尚未执行：用新副本按说明启动，测试驾驶与重开，检查缺失资源；如果宣称离线可用，再验证断网启动。
