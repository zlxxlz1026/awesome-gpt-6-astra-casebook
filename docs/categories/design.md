# ✨ GPT-6 Astra — Design & creative work

[English](design.md) · [简体中文](design.zh-CN.md) · [Home](../../README.md) · [Full gallery](../gallery.md)
...
- [Astral liquid-glass welcome screen](#astral-liquid-glass) · **Full prompt**
- [A portrait assembled from memory](#memory-portrait) · **Full prompt**
- [Astra imagines a thought before language](#astra-mind-midjourney) · **Full prompt**
- [Astro-themed liquid-glass welcome screen](#astro-liquid-glass-welcome) · **Full prompt**
