...
[English](design.md) · [简体中文](design.zh-CN.md) · [返回首页](../../README.zh-CN.md) · [完整图册](../gallery.zh-CN.md)
...
- [星空液态玻璃欢迎页](#astral-liquid-glass) · **完整提示词**
- [由记忆拼成的个人画像](#memory-portrait) · **完整提示词**
- [Astra 想象语言诞生前的念头](#astra-mind-midjourney) · **完整提示词**
- [星体主题液态玻璃欢迎页](#astro-liquid-glass-welcome) · **完整提示词**
