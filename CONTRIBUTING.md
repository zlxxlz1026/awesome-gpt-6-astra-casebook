...
2. Register an unseen link with `add-source URL --reason 'Why review this / 收集原因'` while reviewing locally. Do not include it in a release until its prompt is public and verified. / 新链接可先在本地登记；提示词公开并核验前不要纳入发布版本。
